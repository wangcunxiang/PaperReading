...
2. 每期会组织两个群，标准群和非标群。标准群：向群主持人私发100元押金。该期结束，则按目标完成比例返还押金，剩余部分会统一以手气红包形式发放至群中。（返还规则：例如A同学目标打卡20篇，进群时向主持人发100元，若该期结束时实际打卡为15篇，则返还75元，剩下25元以手气红包形式发至群中。）；非标群：无需押金直接进群。
...
6. 打卡篇数要求：建议在10-20篇之间。标准群最低为5篇，非标群不设要求。

## For 主持人
1. 活动开始前：创建两个群聊，并将参与的同学拉入群中。记录每位参与同学的打卡目标，收取并记录每位参与同学的目标金额。并将新加入同学拉入总群。
